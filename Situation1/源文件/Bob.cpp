...
mpz_t c1a_1, c1a_2;
mpz_t c2a_1, c2a_2;
mpz_t shared_KeyBC, shared_KeyAB;
mpz_t pa, pb;
mpz_t ga, gb;
mpz_t Getc1a, Getc2a;
mpz_t Getc1b, Getc2b;
...
int init1()
{
	...
	mpz_set_str(shared_KeyBC, tmp7, 37);
	char temp1[1024];
	char temp2[1024];
	char temp3[1024];
...
{
	init1();
	Elgamal_Decryption(c1x, c2x, shared_KeyBC, p, g, &x);
	Elgamal_Decryption(c1y, c2y, shared_KeyBC, p, g, &y);
	Elgamal_Decryption(c1k, c2k, shared_KeyBC, p, g, &k);
